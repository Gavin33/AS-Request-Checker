...
export interface Token {
     ...
     */
    // GAVIN: startIndex isn't a property of the start token. Nor is stopIndex. It's just start and stop. I'm not going to change this command every time I transpile -_-
